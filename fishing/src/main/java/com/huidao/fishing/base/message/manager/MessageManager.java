package com.huidao.fishing.base.message.manager;
...
import com.huidao.fishing.base.message.dto.MsgDto;
...
public class MessageManager {
	 ...
	 * @param md
	 */
	public void sendMsg(Session session, MsgDto md) {
		String msg = null;
		try {
	 ...
	 * @param md
	 */
	public void sendMsg(Session session, String code, Object data) {
		MsgDto msg = getMsg(code, data);
		sendMsg(session, msg);

	}

	public void sendMsg(Session session, String code) {
	 ...
	 * @param md
	 */
	public void sendMsg(String userId, MsgDto md) {
		try {
	...
	public void sendMsg(String userId, String code, Object data) {
		MsgDto msg = getMsg(code, data);
		sendMsg(userId, msg);
	}

	public void sendMsg(String userId, String code) {
		MsgDto msg = getMsg(code, null);
		sendMsg(userId, msg);
	}

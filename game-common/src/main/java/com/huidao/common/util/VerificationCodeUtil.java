...
public class VerificationCodeUtil {
	 ...
	 * @throws IOException
	 */
	public static void generateCodeAndPic(int width,int height,HttpServletResponse response, IValidateCodeDB validateCodeDB)
			throws IOException {
		// 定义图像buffer
		...
		validateCodeDB.save("validateCode", randomCode.toString());
		// 验证码输出到web页面
